...
class FairseqAdam(FairseqOptimizer):
    ...
    def __init__(self, args, params):
        ...
        if use_fused_adam:
            ...
            # self._optimizer = fused_adam_cls(filter(lambda p : p.requires_grad, params), **self.optimizer_config)
            self._optimizer = fused_adam_cls(params, **self.optimizer_config)
        else:
            # self._optimizer = Adam(filter(lambda p : p.requires_grad, params), **self.optimizer_config)
